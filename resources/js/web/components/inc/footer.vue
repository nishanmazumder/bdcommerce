                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3 r-margin-top wide-mobile">
                                <div class="single-text">
                                    ...
                                    <div class="clearfix instagram">
                                        <ul>
                                            <li><a href="#"><img v-bind:src="'../storage/img/footer/in1.png'" alt="Instagram" /></a></li>
                                            <li><a href="#"><img v-bind:src="'../storage/img/footer/in2.png'" alt="Instagram" /></a></li>
                                            <li><a href="#"><img v-bind:src="'../storage/img/footer/in3.png'" alt="Instagram" /></a></li>
                                            <li><a href="#"><img v-bind:src="'../storage/img/footer/in4.png'" alt="Instagram" /></a></li>
                                            <li><a href="#"><img v-bind:src="'../storage/img/footer/in5.png'" alt="Instagram" /></a></li>
                                            <li><a href="#"><img v-bind:src="'../storage/img/footer/in6.png'" alt="Instagram" /></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
